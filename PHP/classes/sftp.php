...
class SFTPConnection
{
	...
	public function __construct(string $host = SFTP_HOST, int $port = SFTP_PORT | 22)
	{
	...
	public function login(string $username = SFTP_USERNAME, string $password = SFTP_PASSWORD)
	{
